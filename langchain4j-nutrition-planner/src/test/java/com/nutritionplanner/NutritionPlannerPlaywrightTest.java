...
class NutritionPlannerPlaywrightTest {
    ...
    void generatePlanFlow() {
        ...
        // Check Monday breakfast, lunch, dinner
    ...
    void emptySelectionHandledGracefully() {
        ...
        // Click Generate Plan with no days selected
        page.click("button[type=submit]");

        // Should not crash — either shows empty plan or a message
        page.waitForSelector("#result", new Page.WaitForSelectorOptions().setTimeout(30000));
        // No uncaught exceptions means the app handled it gracefully
    }
}
